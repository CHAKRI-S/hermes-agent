...
KANBAN_GUIDANCE = (
    ...
    "\n"
    "## Local dev servers\n"
    "Before starting a dev server, reuse an existing same-project listener. "
    "Don't dodge port collisions with random ports. Track/stop processes before "
    "finishing unless told otherwise; report reused/started/stopped listeners.\n"
    "\n"
    "## Orchestrator mode\n"
    "\n"
