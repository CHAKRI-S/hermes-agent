...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("read", "Read Discord history in this channel/thread with a selectable limit, then answer", "Session",
               gateway_only=True, args_hint="[limit: 200] [prompt: question]"),
    CommandDef("threadread", "Create a Discord thread, read parent-channel history with a selectable limit, then summarize in the thread", "Session",
               gateway_only=True, args_hint='name: "<thread name>" [limit: 200] [prompt: question]'),
    ...
    CommandDef("continue_sprint", "Continue the latest active unfinished sprint plan; use 'auto' for coordinator-selected worker profile",
               "Tools & Skills", args_hint="[auto|notes]"),
    CommandDef("auto_agent", "Route a bounded task through a coordinator-selected worker/profile",
...
_SLACK_VIA_HERMES_ONLY = frozenset({"credits", "billing", "moa", "debug", "insights", "platform", "restart", "update", "usage", "version"})
