...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("read20", "Read last 20 Discord messages in this channel/thread, then answer", "Session",
               gateway_only=True, args_hint="[question]"),
    CommandDef("read50", "Read last 50 Discord messages in this channel/thread, then answer", "Session",
               gateway_only=True, args_hint="[question]"),
    CommandDef("read100", "Read last 100 Discord messages in this channel/thread, then answer", "Session",
               gateway_only=True, args_hint="[question]"),
    CommandDef("read200", "Read last 200 Discord messages in this channel/thread, then answer", "Session",
               gateway_only=True, args_hint="[question]"),
