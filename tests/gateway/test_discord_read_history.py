...
def _ensure_discord_mock():
    ...
    if existing is not None:
        # Another gateway test module already installed its mock — keep its
        # Thread/DMChannel types stable so isinstance() contracts hold across
        # files (mock-order pollution flipped chat_type in _build_slash_event).
        return
